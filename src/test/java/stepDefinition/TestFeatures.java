...
public class TestFeatures {
	...
	public void I_visit_google(String PageTitle)
		...
		DriverManager.driver.get("https://www.anz.com.au/personal/home-loans/calculators-tools/much-borrow/");
		Assert.assertEquals(DriverManager.driver.getPageSource().contains(PageTitle), true, "The Page is not Displayed");
	...
	public void FillNumberOfDependents(int Number) throws IOException, ParserConfigurationException, SAXException {
		...
		new Select(DriverManager.driver.findElement(By.xpath(datareader.getElement("List_NumberOfDependants", "much-borrow"))))
	...
	public void FillYourIncome(String Amount) throws IOException, ParserConfigurationException, SAXException {
		...
		DriverManager.driver.findElement(By.xpath(datareader.getElement("Txt_YourIncomeBeforeTax", "much-borrow"))).sendKeys(Amount);
	}
	...
	public void FilLivingxpenses(String Amount) throws IOException, ParserConfigurationException, SAXException {
		...
		DriverManager.driver.findElement(By.xpath(datareader.getElement("Txt_LivingExpenses", "much-borrow"))).sendKeys(Amount);
	}
	...
	public void FilOtherIncome(String Amount) throws IOException, ParserConfigurationException, SAXException {
		...
		DriverManager.driver.findElement(By.xpath(datareader.getElement("Txt_YourOtherIncome", "much-borrow"))).sendKeys(Amount);
	}
	...
	public void FillCurrentHomeLoanRepayments(String Amount)
		...
		DriverManager.driver.findElement(By.xpath(datareader.getElement("Txt_CurrentHomeLoanRepayments", "much-borrow")))
				.sendKeys(Amount);
	}
	...
	public void FillOtherLoans(String Amount) throws IOException, ParserConfigurationException, SAXException {
		...
		DriverManager.driver.findElement(By.xpath(datareader.getElement("Txt_OtherLoans", "much-borrow"))).sendKeys(Amount);
	}
	...
	public void FillotherCommitments(String Amount) throws IOException, ParserConfigurationException, SAXException {
		...
		DriverManager.driver.findElement(By.xpath(datareader.getElement("Txt_OtherCommitments", "much-borrow"))).sendKeys(Amount);
	}
	...
	public void FillTotalCreditCardLimits(String Amount)
		...
		DriverManager.driver.findElement(By.xpath(datareader.getElement("Txt_TotalCreditCardLimits", "much-borrow")))
				.sendKeys(Amount);
	}
	...
	public void ChoseHomeType(String ApplicationType) throws IOException, ParserConfigurationException, SAXException {
		...
		DriverManager.driver.findElement(By.xpath(datareader.getElement("Radio_HomeToLiveIn", "much-borrow"))).click();
	}
	...
	public void VerifyCallUsMessage() throws IOException, ParserConfigurationException, SAXException {
		...
		Assert.assertTrue(DriverManager.driver.findElement(By.xpath(datareader.getElement("Label_CallUsMessage", "much-borrow")))
				.isDisplayed());
	}
	...
	public void checkTitle(String ApplicationType) throws IOException, ParserConfigurationException, SAXException {
		...
		if ("single".equalsIgnoreCase(ApplicationType)) {
			DriverManager.driver.findElement(By.xpath(datareader.getElement("Raido_application_type_single", "much-borrow"))).click();
		} else {
			DriverManager.driver.findElement(By.xpath(datareader.getElement("Radio_application_type_joint", "much-borrow"))).click();
		}
	...
	public void VerfiyError() throws IOException, ParserConfigurationException, SAXException {
		...
		Assert.assertEquals(
				DriverManager.driver.findElement(By.xpath(datareader.getElement("Error_Required", "much-borrow"))).isDisplayed(),
				true);
	...
	public void ClickOnHowMuchButton() throws IOException, ParserConfigurationException, SAXException {
		...
		DriverManager.driver.findElement(By.xpath(datareader.getElement("Btn_WorkOutHowMuch", "much-borrow"))).click();
	}

	@After public void closeDriver() throws IOException {
